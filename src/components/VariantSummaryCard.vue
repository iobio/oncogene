...
<template>
  <v-card class="px-2 my-1" style="overflow-y: scroll">
    <v-card-title class="summary-card-title">
      Variant Details
    </v-card-title>
    <v-card-text class="summary-scroll-wrapper">
            ...
            <v-container class="summary-viz">
              <v-row dense>
                ...
                <v-col md=9 class="summary-field-value">
                  ...
                  <v-chip v-if="variantSelected && !selectedTranscript.isCanonical" x-small class="ml-1"
                          color="#eed202">Non-Canonical
                  </v-chip>
                </v-col>
              </v-row>
              <v-row dense>
