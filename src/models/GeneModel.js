class GeneModel {
    constructor(globalApp, limitGenes, integration, steph_eutils_key) {
        const GALAXY = 'galaxy';
        ...
        this.EUTILS_API_KEY = steph_eutils_key;
    ...
    getCanonicalTranscript(theGeneObject) {
        let me = this;
        let geneObject = theGeneObject != null ? theGeneObject : window.gene;
        let canonical;
        ...
        let sortedTranscripts = geneObject.transcripts.slice().sort(function(a, b) {
            let aType = +1;
            let bType = +1;
    ...
    promiseGetNCBIGeneSearchesImpl(geneNames) {
        ...
        return new Promise( function(resolve) {
            ...
            if (theGeneNames.length === 0) {
                ...
                var searchUrl = me.NCBI_GENE_SEARCH_URL + "&term=" + "(9606[Taxonomy ID] AND (" + searchGeneExpr + "))" + "&api_key=" + me.EUTILS_API_KEY;
    ...
    adjustGeneRegion(geneObject) {
        ...
        // Don't go past length of reference
