export default class Glyph {
    ...
    showFlaggedSymbol(selection, options) {
        ...
        this.$.extend(attrs, datumAttrs, cellSizeAttrs, options);
        ...
        selection.append("g")
            ...
            .attr("width", function () {
                return cellSizeAttrs.width
            })
            .attr("height", function () {
                return cellSizeAttrs.height
            });
    }
    ...
    showCosmicSymbol(selection, options) {
        ...
        // }
        //
        // me.$.extend(attrs, datumAttrs, cellSizeAttrs, options);
        ...
        self.$.extend(attrs, datumAttrs, cellSizeAttrs, options);
    ...
    showPolyPhenSymbol(selection, options) {
        ...
        this.$.extend(attrs, datumAttrs, options, cellSizeAttrs);
    ...
    showAfSymbol(selection, options) {
        ...
        selection.append("g")
            ...
            .style("fill", function (d) {
                return symbolAttrs[d.clazz].fill;
            })
            .attr("width", function (d) {
                return symbolAttrs[d.clazz].size;
            })
    ...
    showImpactSymbol(selection, d3, options) {
        options = options || {};
    ...
    showImpactBadge(selection, variant, impactClazz, d3, options) {
        var type = null;
        ...
        var symbolScale = d3.scaleLinear()
            .domain([1, 6])
            .range([10, 40]);
        ...
        if (type.toUpperCase() === 'SNP' || type.toUpperCase() === 'MNP') {
            ...
            selection.append("g")
                ...
                .append('path')
                .attr("d", function () {
                    let symbolGenerator = d3.symbol().size(symbolSize);
                    if (type.toUpperCase() === 'DEL') {
                        type = 'symbolTriangle';
                    } else if (type.toUpperCase() === 'INS') {
                        type = 'symbolCircle';
